...
flowchart LR
    ...
    subgraph Host["Agent host"]
      ...
      Mani[("bridge_manifest.json<br/>26 libs · 1386 UFUNCTIONs")]
    end
...
| `UnrealBridgeMaterialLibrary` | Material/master/function introspection and transactional authoring, including validated `UMaterialInstanceConstant` layer-stack snapshot/full replacement/strict-root copy (UE 5.7+ real implementation; UE 5.3-5.6 safe stubs) |
